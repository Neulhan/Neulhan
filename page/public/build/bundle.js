...
var app = (function () {
    ...
    /* src/components/main.svelte generated by Svelte v3.42.4 */
    ...
    /* src/components/portfolio.svelte generated by Svelte v3.42.4 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			div0.innerHTML = /*portfolioHTML*/ ctx[0];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*portfolioHTML*/ 1) div0.innerHTML = /*portfolioHTML*/ ctx[0];		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    const portfolioURL = 'https://raw.githubusercontent.com/Neulhan/Neulhan/master/README.md';
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const getPortfolio = () => __awaiter(void 0, void 0, void 0, function* () {
    		const res = yield fetch(portfolioURL);
    		const { value } = yield res.body.getReader().read();
    		const converter = new showdown.Converter();
    		$$invalidate(0, portfolioHTML = converter.makeHtml(new TextDecoder().decode(value)));
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('portfolioHTML' in $$props) $$invalidate(0, portfolioHTML = $$props.portfolioHTML);
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 17, 2, 290);
    			attr_dev(footer, "class", "svelte-18t16lb");
    			add_location(footer, file$1, 16, 0, 279);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	main0 = new Main({
    			props: { WORD: /*WORD*/ ctx[0] },
    			$$inline: true
    		});

    	port = new Portfolio({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main1, file, 9, 0, 218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main1, t0);
    			mount_component(port, main1, null);
    			append_dev(main1, t1);
    			mount_component(foot, main1, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const main0_changes = {};
    			if (dirty & /*WORD*/ 1) main0_changes.WORD = /*WORD*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ WORD, Main, Port: Portfolio, Foot: Footer });
