...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = `${/*WORD*/ ctx[1]}`;
    			attr_dev(h1, "class", "svelte-106z2dn");
    			add_location(h1, file$1, 20, 2, 293);
    			attr_dev(main, "class", "svelte-106z2dn");
    			add_location(main, file$1, 19, 0, 284);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ WORD, word1 });

    	$$self.$inject_state = $$props => {
    		if ('WORD' in $$props) $$invalidate(1, WORD = $$props.WORD);
    		if ('word1' in $$props) $$invalidate(0, word1 = $$props.word1);
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main1, file, 6, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
